...
// GoogleLogo is kept available for when Google sign-in is re-enabled below.
  ...
  return (
    ...
    >
      ...
      >
        ...
        {error && (
          <p style={{ fontSize: 13, color: T.red, marginTop: 14 }}>{error}</p>
        )}
        <p
          style={{ fontSize: 12, color: T.tx3, marginTop: 22, lineHeight: 1.6 }}
        >
          {t.terms}
        </p>
      </div>
