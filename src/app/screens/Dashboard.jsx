...
export function Dashboard({
  ...
  useEffect(() => {
    const tm = setTimeout(() => setVis(true), 60);
  ...
  useEffect(() => {
    const h = (e) => {
      if ((e.metaKey || e.ctrlKey) && e.key === "Enter" && canLock)
        setModal(true);
    };
  ...
  const burgerItems = [
    ...
    ...(vaults.length > 0
      ? [
          {
            icon: "🏛",
            label: `${t.viewVaults} (${vaults.length})`,
    ...
    >
      <div
        style={{
          maxWidth: 580,
          margin: "0 auto",
          padding: `40px 20px ${isMobile ? "140px" : "120px"}`,
        }}
      >
        {/* HEADER */}
        <header
        ...
        <p style={{ fontSize: 13, color: T.tx2, marginBottom: 8 }}>
          {t.welcomeBack},{" "}
          <span style={{ color: T.violet, fontWeight: 600 }}>
            {user.name?.split(" ")[0]}
          </span>
          {str > 1 && (
            <span
        ...
        <div
          style={{
            ...
            borderRadius: 16,
            border: `1px solid ${canLock ? "rgba(139,92,246,.3)" : T.border}`,
            overflow: "hidden",
            marginBottom: 10,
            boxShadow: canLock
              ? "0 0 0 1px rgba(139,92,246,.08),0 4px 24px rgba(139,92,246,.1)"
              : "none",
        ...
        >
            ...
            {CATS.map((c) => (
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${cat === c.id ? `${c.color}44` : T.border}`,
                  color: cat === c.id ? c.color : T.tx2,
                  transition: "all .15s",
                }}
              >
          ...
          >
            ...
            >
              <span style={{ fontSize: 11, color: T.tx3, fontWeight: 500 }}>
                {t.deadline}
              </span>
              <input
                type="date"
        ...
        {vaults.length > 0 && (
          <div style={{ marginTop: 28 }}>
            ...
            >
              {[
                { l: t.active, v: active, c: T.violet },
                { l: t.open, v: open_, c: T.blue },
                { l: t.done, v: done, c: T.green },
                { l: t.missed_f, v: missed, c: T.red },
              ].map((s) => (
                <div
                  key={s.l}
                  style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <span
                    style={{
                      ...
                      fontSize: 18,
                      fontWeight: 800,
                      color: sr >= 70 ? T.green : sr >= 40 ? T.violet : T.red,
                      minWidth: 42,
                      textAlign: "right",
                    }}
                  >
