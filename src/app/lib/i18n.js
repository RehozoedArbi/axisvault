...
export const STRINGS = {
  en:{
    appName:"IlumviVault", tagline:"Lock in. Level up.",
    ...
    account:"Account",
    // Onboarding
    onboardWelcome:"Welcome to IlumviVault",
    onboardSub:"Before you lock in your first commitment, a couple of quick things.",
    onboardAcceptPre:"I have read and accept the ",
    onboardAcceptLegal:"Legal Notice",
    onboardAcceptAnd:" and the ",
    onboardAcceptPrivacy:"Privacy Policy",
    onboardAcceptPost:".",
    onboardNewsletter:"Send me occasional emails about new features and tips (optional, you can unsubscribe anytime).",
    onboardContinue:"Continue",
    onboardMustAccept:"You need to accept the legal notice and privacy policy to continue.",
    // Account screen
    accountTitle:"Account",
    accountSignedInAs:"Signed in as",
    accountNewsletterTitle:"Newsletter",
    accountNewsletterSub:"Occasional emails about new features and tips. Off by default, never required.",
    accountNewsletterOn:"Subscribed",
    accountNewsletterOff:"Not subscribed",
    accountLegalTitle:"Legal",
    accountPrivacyLink:"Privacy Policy",
    accountLegalLink:"Legal Notice",
    accountDangerTitle:"Danger zone",
    accountDeleteBtn:"Delete my account",
    accountDeleteSub:"Permanently deletes your account, your vaults, and all associated data. This cannot be undone.",
    accountBack:"Back",
    // Delete account modal
    deleteTitle:"Delete your account?",
    deleteSub:"This will permanently delete your account, every vault, and all your data. This action cannot be undone.",
    deleteTypeWord:"DELETE",
    deleteTypeLabel:"Type",
    deleteTypeToConfirm:"to confirm",
    deleteConfirmBtn:"Delete my account",
    deleteCancelBtn:"Cancel",
    deleteDeleting:"Deleting…",
    deleteSuccessToast:"Account deleted. Goodbye 👋",
    deleteErrorToast:"Something went wrong. Please try again.",
  },
  fr:{
    appName:"IlumviVault", tagline:"Engage. Verrouille. Livre.",
    ...
    account:"Compte",
    // Onboarding
    onboardWelcome:"Bienvenue sur IlumviVault",
    onboardSub:"Avant de verrouiller ton premier engagement, deux petites choses.",
    onboardAcceptPre:"J'ai lu et j'accepte les ",
    onboardAcceptLegal:"mentions légales",
    onboardAcceptAnd:" et la ",
    onboardAcceptPrivacy:"politique de confidentialité",
    onboardAcceptPost:".",
    onboardNewsletter:"Je souhaite recevoir occasionnellement des e-mails sur les nouveautés et astuces (optionnel, désabonnement possible à tout moment).",
    onboardContinue:"Continuer",
    onboardMustAccept:"Tu dois accepter les mentions légales et la politique de confidentialité pour continuer.",
    // Account screen
    accountTitle:"Compte",
    accountSignedInAs:"Connecté en tant que",
    accountNewsletterTitle:"Newsletter",
    accountNewsletterSub:"E-mails occasionnels sur les nouveautés et astuces. Désactivé par défaut, jamais obligatoire.",
    accountNewsletterOn:"Abonné",
    accountNewsletterOff:"Non abonné",
    accountLegalTitle:"Légal",
    accountPrivacyLink:"Politique de confidentialité",
    accountLegalLink:"Mentions légales",
    accountDangerTitle:"Zone dangereuse",
    accountDeleteBtn:"Supprimer mon compte",
    accountDeleteSub:"Supprime définitivement ton compte, tes coffres et toutes les données associées. Cette action est irréversible.",
    accountBack:"Retour",
    // Delete account modal
    deleteTitle:"Supprimer ton compte ?",
    deleteSub:"Cela supprimera définitivement ton compte, tous tes coffres et toutes tes données. Cette action est irréversible.",
    deleteTypeWord:"SUPPRIMER",
    deleteTypeLabel:"Tape",
    deleteTypeToConfirm:"pour confirmer",
    deleteConfirmBtn:"Supprimer mon compte",
    deleteCancelBtn:"Annuler",
    deleteDeleting:"Suppression…",
    deleteSuccessToast:"Compte supprimé. À bientôt 👋",
    deleteErrorToast:"Une erreur est survenue. Réessaie.",
  },
};
